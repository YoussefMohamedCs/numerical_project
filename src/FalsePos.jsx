...
export default function FalsePos() {
    const [equation , setEquation] = useState("x^+(3*x)-5")
 ...
 const [eps , setEps] = useState(0)
     ...
     // const eps = 2.0;
    //  function f(x) {
    //      return (-3*Math.pow(x, 3)) + (19*Math.pow(x , 2)) - (20*x) - 13;
    //  }
     function bisect() {
 ...
 <input type="text" className='equField w-100'  onKeyUp={(e)=> setEquation(e.target.value)}  placeholder='x^+(3*x)-5' />
